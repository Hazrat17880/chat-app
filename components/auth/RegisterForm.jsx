...
// --- Constants & Configurations (Moved outside component for performance) ---
...
const FormInput = ({ id, label, type, value, onChange, placeholder, error, icon, showToggle, onToggle, isToggled }) => (
  <div>
...
const validateForm = (data) => {
  ...
  } else if (trimmedPhone.replace(/[\s\-\(\)\.]/g, "").length < 10) {
...
export default function RegisterForm() {
  ...
  // SVG Icons mapped to fields
  const icons = {
    username: <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>,
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-white to-blue-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="bg-white p-8 sm:p-10 rounded-2xl shadow-xl w-full max-w-md border border-gray-100/80">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-2 text-sm">Join the conversation today</p>
        </div>
        ...
        <form onSubmit={handleSubmit} noValidate className="space-y-5">
          ...
          <div className="space-y-1.5">
            <FormInput
              ...
              icon={icons.phone}
            />
            <p className="text-xs text-gray-400 pl-1">Format: +1 (555) 123-4567 or 5551234567</p>
          </div>
          ...
          <div>
            ...
            {formData.password && (
              <div className="mt-3 pl-1 animate-in fade-in duration-200">
